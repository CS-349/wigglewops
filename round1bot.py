...
PEPPER_SLOPE = 0.001
PEPPER_MIN_POSITION = 77  # keep most of the drift-capture core
PEPPER_TARGET_POSITION = 77  # reload toward the middle of the trading band
PEPPER_MM_OFFSET = 2  # best prior MM compromise from the pepper search
PEPPER_EDGE_OFFSET = 3  # lean harder at the edges of the 75-80 band
    ...
    def run(self, state: TradingState):
        ...
        for product, order_depth in state.order_depths.items():
            ...
            if product == "ASH_COATED_OSMIUM":
                ...
                # Phase 1: buy up to the core long as quickly as possible
                ...
                # Phase 2: penny2 market making around fair value, but keep the core long
                if bba:
                    bot_bid, bot_ask = bba
                    ...
                    bid_offset = PEPPER_EDGE_OFFSET if position <= PEPPER_MIN_POSITION + 1 else PEPPER_MM_OFFSET
                    ask_offset = PEPPER_EDGE_OFFSET if position >= limit - 1 else PEPPER_MM_OFFSET
